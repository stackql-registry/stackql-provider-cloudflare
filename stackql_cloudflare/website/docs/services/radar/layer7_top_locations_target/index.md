--- 
title: layer7_top_locations_target
hide_title: false
hide_table_of_contents: false
keywords:
  - layer7_top_locations_target
  - radar
  - cloudflare
...
Creates, updates, deletes, gets or lists a <code>layer7_top_locations_target</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="layer7_top_locations_target" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.radar.layer7_top_locations_target" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td><a href="#parameter-limit"><code>limit</code></a>, <a href="#parameter-name"><code>name</code></a>, <a href="#parameter-dateRange"><code>dateRange</code></a>, <a href="#parameter-dateStart"><code>dateStart</code></a>, <a href="#parameter-dateEnd"><code>dateEnd</code></a>, <a href="#parameter-continent"><code>continent</code></a>, <a href="#parameter-mitigationProduct"><code>mitigationProduct</code></a>, <a href="#parameter-format"><code>format</code></a></td>
    <td>Retrieves the top target locations of and by layer 7 attacks. Values are a percentage out of the total layer 7 attacks. The target location is determined by the attacked zone's billing country, when available.</td>
</tr>
</tbody>
</table>
...
meta,
top_0
FROM cloudflare.radar.layer7_top_locations_target
WHERE limit = '{{ limit }}'
AND name = '{{ name }}'
