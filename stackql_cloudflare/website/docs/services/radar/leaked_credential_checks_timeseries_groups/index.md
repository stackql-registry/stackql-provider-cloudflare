--- 
title: leaked_credential_checks_timeseries_groups
hide_title: false
hide_table_of_contents: false
keywords:
  - leaked_credential_checks_timeseries_groups
  - radar
  - cloudflare
...
Creates, updates, deletes, gets or lists a <code>leaked_credential_checks_timeseries_groups</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="leaked_credential_checks_timeseries_groups" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.radar.leaked_credential_checks_timeseries_groups" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-aggInterval"><code>aggInterval</code></a>, <a href="#parameter-name"><code>name</code></a>, <a href="#parameter-dateRange"><code>dateRange</code></a>, <a href="#parameter-dateStart"><code>dateStart</code></a>, <a href="#parameter-dateEnd"><code>dateEnd</code></a>, <a href="#parameter-asn"><code>asn</code></a>, <a href="#parameter-location"><code>location</code></a>, <a href="#parameter-continent"><code>continent</code></a>, <a href="#parameter-botClass"><code>botClass</code></a>, <a href="#parameter-compromised"><code>compromised</code></a>, <a href="#parameter-checkResult"><code>checkResult</code></a>, <a href="#parameter-limitPerGroup"><code>limitPerGroup</code></a>, <a href="#parameter-normalization"><code>normalization</code></a>, <a href="#parameter-format"><code>format</code></a></td>
    <td>Retrieves the distribution of HTTP authentication requests, grouped by the specified dimension over time.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-checkResult">
    <td><CopyableCode code="checkResult" /></td>
    <td><code>array</code></td>
    <td>Filters results by leaked credential check result.</td>
</tr>
<tr id="parameter-compromised">
    <td><CopyableCode code="compromised" /></td>
    <td><code>array</code></td>
    <td>Filters results by compromised credential status (clean vs. compromised).</td>
</tr>
...
meta,
serie_0
FROM cloudflare.radar.leaked_credential_checks_timeseries_groups
