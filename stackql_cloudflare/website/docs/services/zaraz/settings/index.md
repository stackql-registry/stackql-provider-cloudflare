...
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.zaraz.settings" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Publish current Zaraz preview configuration for a zone.</td>
</tr>
</tbody>
</table>
...
```sql
EXEC cloudflare.zaraz.settings.publish 
