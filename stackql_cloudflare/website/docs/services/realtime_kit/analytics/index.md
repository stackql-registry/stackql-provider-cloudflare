...
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.realtime_kit.analytics" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Returns day-wise session and recording analytics data of an App for the specified time range start_date to end_date. If start_date and end_date are not provided, the default time range is set from 30 days ago to the current date.</td>
</tr>
</tbody>
</table>
