...
Creates, updates, deletes, gets or lists a <code>spoof</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="spoof" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.radar.spoof" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-spoof"><code>spoof</code></a></td>
    ...
    <td>Retrieves the top TLDs by emails classified as spoof or not.</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr id="parameter-spoof">
    <td><CopyableCode code="spoof" /></td>
    <td><code>string</code></td>
    <td>Spoof classification.</td>
</tr>
<tr id="parameter-arc">
...
meta,
top_0
FROM cloudflare.radar.spoof
WHERE spoof = '{{ spoof }}' -- required
AND limit = '{{ limit }}'
AND name = '{{ name }}'
