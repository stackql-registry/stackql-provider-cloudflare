...
Creates, updates, deletes, gets or lists a <code>cache_reserve_clear</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="cache_reserve_clear" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.zones.cache_reserve_clear" /></td></tr>
</tbody></table>
...
<tr>
    <td><a href="#smart_shield_settings_start_cache_reserve_clear"><CopyableCode code="smart_shield_settings_start_cache_reserve_clear" /></a></td>
...
start_ts,
state
FROM cloudflare.zones.cache_reserve_clear
...
<Tabs
    defaultValue="smart_shield_settings_start_cache_reserve_clear"
    values={[
        { label: 'smart_shield_settings_start_cache_reserve_clear', value: 'smart_shield_settings_start_cache_reserve_clear' },
        { label: 'Manifest', value: 'manifest' }
    ]}
>
<TabItem value="smart_shield_settings_start_cache_reserve_clear">

You can use Cache Reserve Clear to clear your Cache Reserve, but you must first disable Cache Reserve. In most cases, this will be accomplished within 24 hours. You cannot re-enable Cache Reserve while this process is ongoing. Keep in mind that you cannot undo or cancel this operation.

```sql
INSERT INTO cloudflare.zones.cache_reserve_clear (
zone_id
)
SELECT 
'{{ zone_id }}'
...
- name: cache_reserve_clear
  props:
    - name: zone_id
      value: "{{ zone_id }}"
      description: Required parameter for the cache_reserve_clear resource.
`}</CodeBlock>
