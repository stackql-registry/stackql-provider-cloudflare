...
Creates, updates, deletes, gets or lists a <code>layer3_top_attacks</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="layer3_top_attacks" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.radar.layer3_top_attacks" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td><a href="#parameter-limit"><code>limit</code></a>, <a href="#parameter-name"><code>name</code></a>, <a href="#parameter-dateRange"><code>dateRange</code></a>, <a href="#parameter-dateStart"><code>dateStart</code></a>, <a href="#parameter-dateEnd"><code>dateEnd</code></a>, <a href="#parameter-location"><code>location</code></a>, <a href="#parameter-continent"><code>continent</code></a>, <a href="#parameter-ipVersion"><code>ipVersion</code></a>, <a href="#parameter-protocol"><code>protocol</code></a>, <a href="#parameter-limitDirection"><code>limitDirection</code></a>, <a href="#parameter-limitPerLocation"><code>limitPerLocation</code></a>, <a href="#parameter-magnitude"><code>magnitude</code></a>, <a href="#parameter-normalization"><code>normalization</code></a>, <a href="#parameter-format"><code>format</code></a></td>
    <td>Retrieves the top layer 3 attacks from origin to target location. Values are a percentage out of the total layer 3 attacks (with billing country). You can optionally limit the number of attacks by origin/target location (useful if all the top attacks are from or to the same location).</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-limitDirection">
    <td><CopyableCode code="limitDirection" /></td>
    <td><code>string</code></td>
    <td>Specifies whether the `limitPerLocation` applies to the source or target location.</td>
</tr>
<tr id="parameter-limitPerLocation">
    <td><CopyableCode code="limitPerLocation" /></td>
    <td><code>integer</code></td>
    <td>Limits the number of attacks per origin/target (refer to `limitDirection` parameter) location.</td>
</tr>
...
<tr id="parameter-magnitude">
    <td><CopyableCode code="magnitude" /></td>
    <td><code>string</code></td>
    <td>Orders results based on attack magnitude, defined by total mitigated bytes or total mitigated attacks.</td>
</tr>
...
<tr id="parameter-protocol">
    ...
    <td><code>array</code></td>
    <td>Filters the results by layer 3/4 protocol.</td>
</tr>
</tbody>
</table>
...
meta,
top_0
FROM cloudflare.radar.layer3_top_attacks
WHERE limit = '{{ limit }}'
AND name = '{{ name }}'
...
AND limitDirection = '{{ limitDirection }}'
AND limitPerLocation = '{{ limitPerLocation }}'
