...
Creates, updates, deletes, gets or lists a <code>netflows_top_ases</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="netflows_top_ases" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.radar.netflows_top_ases" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Retrieves the top autonomous systems by network traffic (NetFlows).</td>
</tr>
</tbody>
</table>
...
meta,
top_0
FROM cloudflare.radar.netflows_top_ases
WHERE limit = '{{ limit }}'
AND name = '{{ name }}'
