...
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.streams.keys" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The unique identifier for the signing key. (example: e9db990a82666dd571c77f944a5c5c8d)</td>
</tr>
<tr>
    <td><CopyableCode code="created" /></td>
    <td><code>string (date-time)</code></td>
    <td>The date and time a signing key was created. (example: 2014-01-02T02:20:00Z)</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Lists the video ID and creation date and time when a signing key was created.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-account_id"><code>account_id</code></a></td>
    <td></td>
    <td>Creates an RSA private key in PEM and JWK formats. Key files are only displayed once after creation. Keys are created, used, and deleted independently of videos, and every key can sign any video.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Deletes signing keys and revokes all signed URLs generated with the key.</td>
</tr>
</tbody>
</table>
