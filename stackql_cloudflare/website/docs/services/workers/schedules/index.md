...
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.workers.schedules" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Fetches Cron Triggers for a Worker.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-account_id"><code>account_id</code></a>, <a href="#parameter-script_name"><code>script_name</code></a></td>
    <td></td>
    <td>Updates Cron Triggers for a Worker.</td>
</tr>
</tbody>
</table>
...
cron,
modified_on
FROM cloudflare.workers.schedules
...
```sql
REPLACE cloudflare.workers.schedules
SET 
