...
Creates, updates, deletes, gets or lists a <code>spam</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="spam" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.radar.spam" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-spam"><code>spam</code></a></td>
    ...
    <td>Retrieves the top TLDs by emails classified as spam or not.</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr id="parameter-spam">
    <td><CopyableCode code="spam" /></td>
...
meta,
top_0
FROM cloudflare.radar.spam
WHERE spam = '{{ spam }}' -- required
AND limit = '{{ limit }}'
AND name = '{{ name }}'
