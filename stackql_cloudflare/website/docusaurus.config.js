...
const providerTitle = "Cloudflare";
  ...
  presets: [
    [
      ...
      ({
        ...
        // Disable the built-in blog. The `/blog` route is served by
        // src/pages/blog.js (a meta-refresh to https://stackql.io/blog),
        // so the default blog plugin would just collide.
        blog: false,
        theme: {
