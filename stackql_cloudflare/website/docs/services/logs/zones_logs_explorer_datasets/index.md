--- 
title: zones_logs_explorer_datasets
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>zones_logs_explorer_datasets</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="zones_logs_explorer_datasets" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.logs.zones_logs_explorer_datasets" /></td></tr>
</tbody></table>
...
<tr>
    <td><a href="#post_zones_zone_id_logs_explorer_datasets"><CopyableCode code="post_zones_zone_id_logs_explorer_datasets" /></a></td>
...
<tr>
    <td><a href="#put_zones_zone_id_logs_explorer_datasets_dataset_id"><CopyableCode code="put_zones_zone_id_logs_explorer_datasets_dataset_id" /></a></td>
...
<Tabs
    defaultValue="post_zones_zone_id_logs_explorer_datasets"
    values={[
        { label: 'post_zones_zone_id_logs_explorer_datasets', value: 'post_zones_zone_id_logs_explorer_datasets' },
        { label: 'Manifest', value: 'manifest' }
    ]}
>
<TabItem value="post_zones_zone_id_logs_explorer_datasets">
...
<Tabs
    defaultValue="put_zones_zone_id_logs_explorer_datasets_dataset_id"
    values={[
        { label: 'put_zones_zone_id_logs_explorer_datasets_dataset_id', value: 'put_zones_zone_id_logs_explorer_datasets_dataset_id' }
    ]}
>
<TabItem value="put_zones_zone_id_logs_explorer_datasets_dataset_id">
