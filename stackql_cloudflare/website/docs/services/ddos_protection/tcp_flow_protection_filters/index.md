--- 
title: tcp_flow_protection_filters
hide_title: false
...
Creates, updates, deletes, gets or lists a <code>tcp_flow_protection_filters</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="tcp_flow_protection_filters" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.ddos_protection.tcp_flow_protection_filters" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Get a TCP Flow Protection filter specified by the given UUID.</td>
</tr>
<tr>
    ...
    <td>List all TCP Flow Protection filters for an account.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Create a TCP Flow Protection filter for an account.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-account_id"><code>account_id</code></a>, <a href="#parameter-filter_id"><code>filter_id</code></a></td>
    <td></td>
    <td>Update a TCP Flow Protection filter specified by the given UUID.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-account_id"><code>account_id</code></a>, <a href="#parameter-filter_id"><code>filter_id</code></a></td>
    <td></td>
    <td>Delete a TCP Flow Protection filter specified by the given UUID.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-account_id"><code>account_id</code></a></td>
    <td></td>
    <td>Delete all TCP Flow Protection filters for an account.</td>
</tr>
</tbody>
</table>
...
- name: tcp_flow_protection_filters
  props:
    - name: account_id
      value: "{{ account_id }}"
      description: Required parameter for the tcp_flow_protection_filters resource.
    - name: expression
      value: "{{ expression }}"
      description: |
