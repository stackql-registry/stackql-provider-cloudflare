...
<tbody>
<tr>
    <td><a href="#devices_set_local_domain_fallback_list_for_a_device_settings_policy"><CopyableCode code="devices_set_local_domain_fallback_list_for_a_device_settings_policy" /></a></td>
...
<tr>
    <td><a href="#devices_set_local_domain_fallback_list"><CopyableCode code="devices_set_local_domain_fallback_list" /></a></td>
    <td><CopyableCode code="replace" /></td>
...
<Tabs
    defaultValue="devices_set_local_domain_fallback_list_for_a_device_settings_policy"
    values={[
        { label: 'devices_set_local_domain_fallback_list_for_a_device_settings_policy', value: 'devices_set_local_domain_fallback_list_for_a_device_settings_policy' },
        { label: 'devices_set_local_domain_fallback_list', value: 'devices_set_local_domain_fallback_list' }
    ]}
>
<TabItem value="devices_set_local_domain_fallback_list_for_a_device_settings_policy">
...
<TabItem value="devices_set_local_domain_fallback_list">
