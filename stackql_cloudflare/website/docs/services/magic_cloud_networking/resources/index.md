...
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.magic_cloud_networking.resources" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Read an resource from the Resource Catalog (Closed Beta).</td>
</tr>
<tr>
    <td><a href="#export"><CopyableCode code="export" /></a></td>
    <td><CopyableCode code="select" /></td>
    <td><a href="#parameter-account_id"><code>account_id</code></a></td>
    <td><a href="#parameter-provider_id"><code>provider_id</code></a>, <a href="#parameter-resource_type"><code>resource_type</code></a>, <a href="#parameter-resource_id"><code>resource_id</code></a>, <a href="#parameter-region"><code>region</code></a>, <a href="#parameter-resource_group"><code>resource_group</code></a>, <a href="#parameter-search"><code>search</code></a>, <a href="#parameter-order_by"><code>order_by</code></a>, <a href="#parameter-desc"><code>desc</code></a>, <a href="#parameter-v2"><code>v2</code></a></td>
    <td>Export resources in the Resource Catalog as a JSON file (Closed Beta).</td>
</tr>
<tr>
    <td><a href="#policy_preview"><CopyableCode code="policy_preview" /></a></td>
    <td><CopyableCode code="insert" /></td>
    <td><a href="#parameter-account_id"><code>account_id</code></a>, <a href="#parameter-policy"><code>policy</code></a></td>
    <td></td>
    <td>Preview Rego query result against the latest resource catalog (Closed Beta).</td>
</tr>
</tbody>
</table>
...
updated_at,
url
FROM cloudflare.magic_cloud_networking.resources
...
<Tabs
    defaultValue="policy_preview"
    values={[
        { label: 'policy_preview', value: 'policy_preview' },
        { label: 'Manifest', value: 'manifest' }
    ]}
>
<TabItem value="policy_preview">

Preview Rego query result against the latest resource catalog (Closed Beta).

```sql
INSERT INTO cloudflare.magic_cloud_networking.resources (
policy,
account_id
)
SELECT 
