...
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.iam.resource_types" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-account_id"><code>account_id</code></a>, <a href="#parameter-resource_type_id"><code>resource_type_id</code></a></td>
    <td></td>
    <td>Returns a single SCIM resource type by ID (RFC 7643 Section 6). Valid IDs are `User` and `Group`.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Returns the list of SCIM resource types supported by the Cloudflare SCIM service (RFC 7643 Section 6, RFC 7644 Section 4). Clients use this to discover available resource categories (e.g. Users, Groups) and their associated schemas. Query parameters are not supported on this endpoint.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-resource_type_id">
    <td><CopyableCode code="resource_type_id" /></td>
    <td><code>string</code></td>
    <td></td>
</tr>
</tbody>
