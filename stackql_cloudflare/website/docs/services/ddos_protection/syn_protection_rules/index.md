...
Creates, updates, deletes, gets or lists a <code>syn_protection_rules</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="syn_protection_rules" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.ddos_protection.syn_protection_rules" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>The unique ID of the SYN Protection rule.</td>
</tr>
<tr>
    <td><CopyableCode code="name" /></td>
    <td><code>string</code></td>
    <td>The name of the SYN Protection rule. Value is relative to the 'scope' setting. For 'global' scope, name should be 'global'. For either the 'region' or 'datacenter' scope, name should be the actual name of the region or datacenter, e.g., 'wnam' or 'lax'.</td>
</tr>
<tr>
...
<tr>
    ...
    <td>The creation timestamp of the SYN Protection rule.</td>
</tr>
<tr>
    <td><CopyableCode code="mitigation_type" /></td>
    <td><code>string</code></td>
    <td>The type of mitigation for SYN Protection. Must be one of 'challenge' or 'retransmit'.</td>
</tr>
<tr>
    <td><CopyableCode code="mode" /></td>
    <td><code>string</code></td>
    <td>The mode for SYN Protection. Must be one of 'enabled', 'disabled', 'monitoring'.</td>
</tr>
<tr>
    <td><CopyableCode code="modified_on" /></td>
    <td><code>string (date-time)</code></td>
    <td>The last modification timestamp of the SYN Protection rule.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><code>string</code></td>
    <td>The scope for the SYN Protection rule. Must be one of 'global', 'region', or 'datacenter'.</td>
</tr>
</tbody>
</table>
</TabItem>
...
<tr>
    ...
    <td></td>
    <td>Get a SYN Protection rule specified by the given UUID.</td>
</tr>
<tr>
    ...
    <td>List all SYN Protection rules for an account.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Create a SYN Protection rule for an account.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-account_id"><code>account_id</code></a>, <a href="#parameter-rule_id"><code>rule_id</code></a></td>
    <td></td>
    <td>Update a SYN Protection rule specified by the given UUID.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-account_id"><code>account_id</code></a>, <a href="#parameter-rule_id"><code>rule_id</code></a></td>
    <td></td>
    <td>Delete a SYN Protection rule specified by the given UUID.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-account_id"><code>account_id</code></a></td>
    <td></td>
    <td>Delete all SYN Protection rules for an account.</td>
</tr>
</tbody>
</table>
