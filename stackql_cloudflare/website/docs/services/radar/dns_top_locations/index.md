...
Creates, updates, deletes, gets or lists a <code>dns_top_locations</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="dns_top_locations" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.radar.dns_top_locations" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Retrieves the top locations by DNS queries made to 1.1.1.1 DNS resolver.</td>
</tr>
</tbody>
</table>
...
meta,
top_0
FROM cloudflare.radar.dns_top_locations
WHERE limit = '{{ limit }}'
AND name = '{{ name }}'
