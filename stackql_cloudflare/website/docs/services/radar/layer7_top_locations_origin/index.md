--- 
title: layer7_top_locations_origin
hide_title: false
hide_table_of_contents: false
keywords:
  - layer7_top_locations_origin
  - radar
  - cloudflare
...
Creates, updates, deletes, gets or lists a <code>layer7_top_locations_origin</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="layer7_top_locations_origin" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.radar.layer7_top_locations_origin" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td><a href="#parameter-limit"><code>limit</code></a>, <a href="#parameter-name"><code>name</code></a>, <a href="#parameter-dateRange"><code>dateRange</code></a>, <a href="#parameter-dateStart"><code>dateStart</code></a>, <a href="#parameter-dateEnd"><code>dateEnd</code></a>, <a href="#parameter-asn"><code>asn</code></a>, <a href="#parameter-continent"><code>continent</code></a>, <a href="#parameter-ipVersion"><code>ipVersion</code></a>, <a href="#parameter-httpVersion"><code>httpVersion</code></a>, <a href="#parameter-httpMethod"><code>httpMethod</code></a>, <a href="#parameter-mitigationProduct"><code>mitigationProduct</code></a>, <a href="#parameter-format"><code>format</code></a></td>
    <td>Retrieves the top origin locations of layer 7 attacks. Values are percentages of the total layer 7 attacks, with the origin location determined by the client IP address.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-httpMethod">
    <td><CopyableCode code="httpMethod" /></td>
    <td><code>array</code></td>
    <td>Filters results by HTTP method.</td>
</tr>
...
meta,
top_0
FROM cloudflare.radar.layer7_top_locations_origin
WHERE limit = '{{ limit }}'
AND name = '{{ name }}'
