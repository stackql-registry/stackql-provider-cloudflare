...
Creates, updates, deletes, gets or lists a <code>speed_top_ases</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="speed_top_ases" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.radar.speed_top_ases" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Retrieves the top autonomous systems by bandwidth, latency, jitter, or packet loss, from the previous 90 days of Cloudflare Speed Test data.</td>
</tr>
</tbody>
</table>
...
meta,
top_0
FROM cloudflare.radar.speed_top_ases
WHERE limit = '{{ limit }}'
AND name = '{{ name }}'
AND dateEnd = '{{ dateEnd }}'
AND asn = '{{ asn }}'
