--- 
title: verified_bots_top_categories
hide_title: false
hide_table_of_contents: false
keywords:
  - verified_bots_top_categories
  - radar
  - cloudflare
...
Creates, updates, deletes, gets or lists a <code>verified_bots_top_categories</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="verified_bots_top_categories" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.radar.verified_bots_top_categories" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Retrieves the top verified bot categories by HTTP requests, along with their corresponding percentage, over the total verified bot HTTP requests.</td>
</tr>
</tbody>
</table>
...
meta,
top_0
FROM cloudflare.radar.verified_bots_top_categories
WHERE limit = '{{ limit }}'
AND name = '{{ name }}'
