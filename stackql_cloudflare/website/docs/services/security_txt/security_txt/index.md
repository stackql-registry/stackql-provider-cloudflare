...
Creates, updates, deletes, gets or lists a <code>security_txt</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="security_txt" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.security_txt.security_txt" /></td></tr>
</tbody></table>
...
policy,
preferred_languages
FROM cloudflare.security_txt.security_txt
...
```sql
REPLACE cloudflare.security_txt.security_txt
SET 
...
```sql
DELETE FROM cloudflare.security_txt.security_txt
WHERE zone_id = '{{ zone_id }}' --required
;
```
</TabItem>
