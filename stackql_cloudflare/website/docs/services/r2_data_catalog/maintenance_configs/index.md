...
Creates, updates, deletes, gets or lists a <code>maintenance_configs</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="maintenance_configs" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.r2_data_catalog.maintenance_configs" /></td></tr>
</tbody></table>
...
credential_status,
maintenance_config
FROM cloudflare.r2_data_catalog.maintenance_configs
...
```sql
INSERT INTO cloudflare.r2_data_catalog.maintenance_configs (
compaction,
snapshot_expiration,
account_id,
bucket_name
...
- name: maintenance_configs
  props:
    - name: account_id
      value: "{{ account_id }}"
      description: Required parameter for the maintenance_configs resource.
    - name: bucket_name
      value: "{{ bucket_name }}"
      description: Required parameter for the maintenance_configs resource.
    - name: compaction
