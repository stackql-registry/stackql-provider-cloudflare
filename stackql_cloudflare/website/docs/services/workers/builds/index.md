...
<Tabs
    ...
    values={[
        { label: 'get', value: 'get' },
        { label: 'list_by_script', value: 'list_by_script' },
...
<tr>
    <td><a href="#list_by_script"><CopyableCode code="list_by_script" /></a></td>
    <td><CopyableCode code="select" /></td>
...
<tr>
    ...
    <td><a href="#parameter-version_ids"><code>version_ids</code></a></td>
    <td>Retrieve builds for specific version IDs</td>
</tr>
<tr>
...
<tr id="parameter-version_ids">
    <td><CopyableCode code="version_ids" /></td>
    <td><code>string</code></td>
    <td></td>
</tr>
</tbody>
