...
Creates, updates, deletes, gets or lists a <code>top_tlds</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="top_tlds" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.radar.top_tlds" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Retrieves the top TLDs by number of email messages.</td>
</tr>
</tbody>
</table>
...
meta,
top_0
FROM cloudflare.radar.top_tlds
WHERE limit = '{{ limit }}'
AND name = '{{ name }}'
