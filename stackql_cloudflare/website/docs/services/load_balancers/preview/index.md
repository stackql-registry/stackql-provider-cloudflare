...
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.load_balancers.preview" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-preview_id"><code>preview_id</code></a></td>
    <td></td>
    <td>Get the result of a previous preview operation using the provided preview_id.</td>
</tr>
<tr>
    <td><a href="#load_balancer_monitors_preview_monitor"><CopyableCode code="load_balancer_monitors_preview_monitor" /></a></td>
...
<tr>
    <td><a href="#load_balancer_pools_preview_pool"><CopyableCode code="load_balancer_pools_preview_pool" /></a></td>
    <td><CopyableCode code="insert" /></td>
...
<Tabs
    defaultValue="load_balancer_monitors_preview_monitor"
    values={[
        { label: 'load_balancer_monitors_preview_monitor', value: 'load_balancer_monitors_preview_monitor' },
        { label: 'load_balancer_pools_preview_pool', value: 'load_balancer_pools_preview_pool' },
        { label: 'Manifest', value: 'manifest' }
    ]}
>
<TabItem value="load_balancer_monitors_preview_monitor">
...
<TabItem value="load_balancer_pools_preview_pool">
