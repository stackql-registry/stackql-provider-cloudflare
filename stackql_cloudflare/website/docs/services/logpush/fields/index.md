...
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.logpush.fields" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Lists all fields available for a dataset. The response result is. an object with key-value pairs, where keys are field names, and values are descriptions.</td>
</tr>
<tr>
