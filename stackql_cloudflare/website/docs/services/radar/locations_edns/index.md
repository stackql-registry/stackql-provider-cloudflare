...
Creates, updates, deletes, gets or lists a <code>locations_edns</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="locations_edns" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.radar.locations_edns" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-edns"><code>edns</code></a></td>
    ...
    <td>Retrieves the top locations of DNS queries to AS112 with EDNS (Extension Mechanisms for DNS) support.</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr id="parameter-edns">
    <td><CopyableCode code="edns" /></td>
    <td><code>string</code></td>
    <td>EDNS (Extension Mechanisms for DNS) status.</td>
</tr>
...
meta,
top_0
FROM cloudflare.radar.locations_edns
WHERE edns = '{{ edns }}' -- required
AND limit = '{{ limit }}'
AND name = '{{ name }}'
