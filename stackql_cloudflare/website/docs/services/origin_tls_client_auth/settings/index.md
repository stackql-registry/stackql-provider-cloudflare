...
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.origin_tls_client_auth.settings" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Get whether zone-level authenticated origin pulls is enabled or not. It is false by default.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Enable or disable zone-level authenticated origin pulls. 'enabled' should be set true either before/after the certificate is uploaded to see the certificate in use.</td>
</tr>
</tbody>
</table>
