--- 
title: locations_device_type
hide_title: false
hide_table_of_contents: false
keywords:
  - locations_device_type
  - radar
  - cloudflare
...
Creates, updates, deletes, gets or lists a <code>locations_device_type</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="locations_device_type" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.radar.locations_device_type" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Retrieves the top locations, by HTTP requests, of the requested device type.</td>
</tr>
</tbody>
</table>
...
meta,
top_0
FROM cloudflare.radar.locations_device_type
WHERE device_type = '{{ device_type }}' -- required
AND limit = '{{ limit }}'
AND name = '{{ name }}'
