--- 
title: iqi_timeseries_groups
hide_title: false
hide_table_of_contents: false
keywords:
  - iqi_timeseries_groups
  - radar
  - cloudflare
...
Creates, updates, deletes, gets or lists an <code>iqi_timeseries_groups</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="iqi_timeseries_groups" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.radar.iqi_timeseries_groups" /></td></tr>
</tbody></table>
...
<tr id="parameter-interpolation">
    <td><CopyableCode code="interpolation" /></td>
    <td><code>boolean</code></td>
    <td>Enables interpolation for all series (using the average).</td>
</tr>
...
<tr id="parameter-metric">
    ...
    <td><code>string</code></td>
    <td>Defines which metric to return (bandwidth, latency, or DNS response time).</td>
</tr>
...
meta,
serie_0
FROM cloudflare.radar.iqi_timeseries_groups
...
AND interpolation = '{{ interpolation }}'
AND metric = '{{ metric }}'
AND format = '{{ format }}'
;
```
