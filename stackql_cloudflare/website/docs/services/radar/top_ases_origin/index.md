...
Creates, updates, deletes, gets or lists a <code>top_ases_origin</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="top_ases_origin" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.radar.top_ases_origin" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Retrieves the top origin autonomous systems of layer 7 attacks. Values are percentages of the total layer 7 attacks, with the origin autonomous systems determined by the client IP address.</td>
</tr>
</tbody>
</table>
...
meta,
top_0
FROM cloudflare.radar.top_ases_origin
WHERE limit = '{{ limit }}'
AND name = '{{ name }}'
