...
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.accounts.tokens" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Get information about a specific Account Owned API token.</td>
</tr>
<tr>
    <td><a href="#create"><CopyableCode code="create" /></a></td>
    <td><CopyableCode code="insert" /></td>
    <td><a href="#parameter-account_id"><code>account_id</code></a>, <a href="#parameter-name"><code>name</code></a>, <a href="#parameter-policies"><code>policies</code></a></td>
    <td></td>
    <td>Create a new Account Owned API token.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-account_id"><code>account_id</code></a>, <a href="#parameter-token_id"><code>token_id</code></a></td>
    <td></td>
    <td>Destroy an Account Owned API token.</td>
</tr>
<tr>
    <td><a href="#roll_token"><CopyableCode code="roll_token" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-account_id"><code>account_id</code></a>, <a href="#parameter-token_id"><code>token_id</code></a></td>
    <td></td>
    <td>Roll the Account Owned API token secret.</td>
</tr>
</tbody>
</table>
...
<Tabs
    defaultValue="roll_token"
    values={[
        { label: 'roll_token', value: 'roll_token' }
    ]}
>
<TabItem value="roll_token">
