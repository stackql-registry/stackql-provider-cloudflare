...
Creates, updates, deletes, gets or lists a <code>namespace_instances</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="namespace_instances" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.ai_search.namespace_instances" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-account_id"><code>account_id</code></a>, <a href="#parameter-id"><code>id</code></a>, <a href="#parameter-name"><code>name</code></a></td>
    <td></td>
    <td>Read instance.</td>
</tr>
<tr>
...
<tr>
    ...
    <td><a href="#parameter-account_id"><code>account_id</code></a>, <a href="#parameter-name"><code>name</code></a>, <a href="#parameter-id"><code>id</code></a></td>
    <td></td>
...
sync_interval,
type
FROM cloudflare.ai_search.namespace_instances
...
```sql
INSERT INTO cloudflare.ai_search.namespace_instances (
ai_gateway_id,
ai_search_model,
cache,
cache_threshold,
...
```sql
REPLACE cloudflare.ai_search.namespace_instances
SET 
...
```sql
DELETE FROM cloudflare.ai_search.namespace_instances
WHERE account_id = '{{ account_id }}' --required
AND id = '{{ id }}' --required
AND name = '{{ name }}' --required
;
