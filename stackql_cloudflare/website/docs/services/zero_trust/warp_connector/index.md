...
Creates, updates, deletes, gets or lists a <code>warp_connector</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="warp_connector" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.zero_trust.warp_connector" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td>Fetches a single Warp Connector Tunnel.</td>
</tr>
<tr>
    ...
    <td>Lists and filters Warp Connector Tunnels in an account.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Creates a new Warp Connector Tunnel in an account.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-account_id"><code>account_id</code></a>, <a href="#parameter-tunnel_id"><code>tunnel_id</code></a></td>
    <td></td>
    <td>Updates an existing Warp Connector Tunnel.</td>
</tr>
<tr>
    ...
    <td><a href="#parameter-account_id"><code>account_id</code></a>, <a href="#parameter-tunnel_id"><code>tunnel_id</code></a></td>
    <td></td>
    <td>Deletes a Warp Connector Tunnel from an account.</td>
</tr>
<tr>
    <td><a href="#update_failover"><CopyableCode code="update_failover" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-account_id"><code>account_id</code></a>, <a href="#parameter-tunnel_id"><code>tunnel_id</code></a>, <a href="#parameter-client_id"><code>client_id</code></a></td>
    <td></td>
    <td>Triggers a manual failover for a specific WARP Connector Tunnel, setting the specified client as the active connector. The tunnel must be configured for high availability (HA) and the client must be linked to the tunnel.</td>
</tr>
</tbody>
</table>
...
<Tabs
    defaultValue="update_failover"
    values={[
        { label: 'update_failover', value: 'update_failover' }
    ]}
>
<TabItem value="update_failover">
