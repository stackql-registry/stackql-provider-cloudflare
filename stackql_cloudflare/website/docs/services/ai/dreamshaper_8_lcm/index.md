...
Creates, updates, deletes, gets or lists a <code>dreamshaper_8_lcm</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="dreamshaper_8_lcm" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.ai.dreamshaper_8_lcm" /></td></tr>
</tbody></table>
...
<tbody>
<tr>
    <td><a href="#workers_ai_post_run_cf_lykon_dreamshaper_8_lcm"><CopyableCode code="workers_ai_post_run_cf_lykon_dreamshaper_8_lcm" /></a></td>
    ...
    <td>Runs inference on the @cf/lykon/dreamshaper-8-lcm model.</td>
</tr>
</tbody>
</table>
...
<Tabs
    defaultValue="workers_ai_post_run_cf_lykon_dreamshaper_8_lcm"
    values={[
        { label: 'workers_ai_post_run_cf_lykon_dreamshaper_8_lcm', value: 'workers_ai_post_run_cf_lykon_dreamshaper_8_lcm' },
        { label: 'Manifest', value: 'manifest' }
    ]}
>
<TabItem value="workers_ai_post_run_cf_lykon_dreamshaper_8_lcm">

Runs inference on the @cf/lykon/dreamshaper-8-lcm model.

```sql
INSERT INTO cloudflare.ai.dreamshaper_8_lcm (
guidance,
height,
image,
image_b64,
...
- name: dreamshaper_8_lcm
  props:
    - name: account_id
      value: "{{ account_id }}"
      description: Required parameter for the dreamshaper_8_lcm resource.
    - name: guidance
      value: {{ guidance }}
      description: |
