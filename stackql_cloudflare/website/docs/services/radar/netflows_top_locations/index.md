...
Creates, updates, deletes, gets or lists a <code>netflows_top_locations</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="netflows_top_locations" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.radar.netflows_top_locations" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Retrieves the top locations by network traffic (NetFlows).</td>
</tr>
</tbody>
</table>
...
meta,
top_0
FROM cloudflare.radar.netflows_top_locations
WHERE limit = '{{ limit }}'
AND name = '{{ name }}'
