...
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.ai_search.namespaces_instance_jobs" /></td></tr>
</tbody></table>
...
source,
started_at
FROM cloudflare.ai_search.namespaces_instance_jobs
...
```sql
INSERT INTO cloudflare.ai_search.namespaces_instance_jobs (
description,
id,
account_id,
name
