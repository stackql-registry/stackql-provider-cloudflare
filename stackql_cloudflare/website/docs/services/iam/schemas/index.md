...
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.iam.schemas" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-account_id"><code>account_id</code></a>, <a href="#parameter-schema_id"><code>schema_id</code></a></td>
    <td></td>
    <td>Returns a single SCIM schema definition by schema URI ID (RFC 7643 Section 7). Valid IDs are `urn:ietf:params:scim:schemas:core:2.0:User` and `urn:ietf:params:scim:schemas:core:2.0:Group`.</td>
</tr>
<tr>
    ...
    <td></td>
    <td>Returns the list of SCIM schemas supported by the Cloudflare SCIM service (RFC 7643 Section 7, RFC 7644 Section 4). Clients use this to introspect the attributes of each resource type. Query parameters are not supported on this endpoint.</td>
</tr>
</tbody>
</table>
