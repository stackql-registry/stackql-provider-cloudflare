...
Creates, updates, deletes, gets or lists a <code>layer7_top_attacks</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="layer7_top_attacks" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.radar.layer7_top_attacks" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td></td>
    <td><a href="#parameter-limit"><code>limit</code></a>, <a href="#parameter-name"><code>name</code></a>, <a href="#parameter-dateRange"><code>dateRange</code></a>, <a href="#parameter-dateStart"><code>dateStart</code></a>, <a href="#parameter-dateEnd"><code>dateEnd</code></a>, <a href="#parameter-asn"><code>asn</code></a>, <a href="#parameter-location"><code>location</code></a>, <a href="#parameter-continent"><code>continent</code></a>, <a href="#parameter-mitigationProduct"><code>mitigationProduct</code></a>, <a href="#parameter-limitDirection"><code>limitDirection</code></a>, <a href="#parameter-limitPerLocation"><code>limitPerLocation</code></a>, <a href="#parameter-normalization"><code>normalization</code></a>, <a href="#parameter-format"><code>format</code></a></td>
    <td>Retrieves the top attacks from origin to target location. Values are percentages of the total layer 7 attacks (with billing country). The attack magnitude can be defined by the number of mitigated requests or by the number of zones affected. You can optionally limit the number of attacks by origin/target location (useful if all the top attacks are from or to the same location).</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-mitigationProduct">
    <td><CopyableCode code="mitigationProduct" /></td>
    <td><code>array</code></td>
    <td>Filters the results by layer 7 mitigation product.</td>
</tr>
...
meta,
top_0
FROM cloudflare.radar.layer7_top_attacks
WHERE limit = '{{ limit }}'
AND name = '{{ name }}'
...
AND mitigationProduct = '{{ mitigationProduct }}'
