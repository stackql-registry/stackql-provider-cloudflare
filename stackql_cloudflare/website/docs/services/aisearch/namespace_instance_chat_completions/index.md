...
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.aisearch.namespace_instance_chat_completions" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-id"><code>id</code></a>, <a href="#parameter-account_id"><code>account_id</code></a>, <a href="#parameter-name"><code>name</code></a>, <a href="#parameter-messages"><code>messages</code></a></td>
    <td></td>
...
- name: namespace_instance_chat_completions
  props:
    - name: id
      value: "{{ id }}"
      description: Required parameter for the namespace_instance_chat_completions resource.
    - name: account_id
      value: "{{ account_id }}"
      description: Required parameter for the namespace_instance_chat_completions resource.
    - name: name
