...
<tr><td><b>Id</b></td><td><CopyableCode code="cloudflare.zones.healthchecks" /></td></tr>
</tbody></table>
...
<tr>
    <td><a href="#smart_shield_create_health_check"><CopyableCode code="smart_shield_create_health_check" /></a></td>
...
<tr>
    <td><a href="#smart_shield_patch_health_check"><CopyableCode code="smart_shield_patch_health_check" /></a></td>
...
<tr>
    <td><a href="#smart_shield_update_health_check"><CopyableCode code="smart_shield_update_health_check" /></a></td>
    <td><CopyableCode code="replace" /></td>
    <td><a href="#parameter-healthcheck_id"><code>healthcheck_id</code></a>, <a href="#parameter-zone_id"><code>zone_id</code></a>, <a href="#parameter-success"><code>success</code></a>, <a href="#parameter-errors"><code>errors</code></a>, <a href="#parameter-messages"><code>messages</code></a>, <a href="#parameter-result"><code>result</code></a></td>
    <td></td>
    <td>Update a configured health check.</td>
</tr>
<tr>
    <td><a href="#smart_shield_delete_health_check"><CopyableCode code="smart_shield_delete_health_check" /></a></td>
...
<Tabs
    defaultValue="smart_shield_create_health_check"
    values={[
        { label: 'smart_shield_create_health_check', value: 'smart_shield_create_health_check' },
        { label: 'Manifest', value: 'manifest' }
    ]}
>
<TabItem value="smart_shield_create_health_check">
...
<Tabs
    defaultValue="smart_shield_patch_health_check"
    values={[
        { label: 'smart_shield_patch_health_check', value: 'smart_shield_patch_health_check' }
    ]}
>
<TabItem value="smart_shield_patch_health_check">
...
<Tabs
    defaultValue="smart_shield_update_health_check"
    values={[
        { label: 'smart_shield_update_health_check', value: 'smart_shield_update_health_check' }
    ]}
>
<TabItem value="smart_shield_update_health_check">
...
<Tabs
    defaultValue="smart_shield_delete_health_check"
    values={[
        { label: 'smart_shield_delete_health_check', value: 'smart_shield_delete_health_check' }
    ]}
>
<TabItem value="smart_shield_delete_health_check">
